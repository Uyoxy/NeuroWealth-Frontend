  ...
  if (events.length === 0) {
    return (
      <p className="text-xs text-slate-500 py-3 text-center">
        No events yet — start the stream to see live updates.
      </p>
    );
  }
    ...
    <div className="space-y-6">
      ...
      >
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="mt-0.5 text-xs text-slate-500">
                Fires deposits, withdrawals, and rebalances every 4–9 s
              </p>
            </div>
          </div>
        ...
        <div className="mt-4 grid grid-cols-2 gap-4 rounded-lg border border-white/5 bg-white/3 p-3 sm:grid-cols-4">
          <DeltaBadge label="Events fired" value={String(eventCount)} />
          <DeltaBadge label="Δ Balance" value={deltaBalanceStr} mono />
          <DeltaBadge label="Δ Yield" value={deltaYieldStr} mono />
          <DeltaBadge label="Δ APY" value={deltaApyStr} mono />
        </div>
